 ...
 * @author Duda
 */
public class FrameAutoresList extends javax.swing.JDialog {
    ...
    public FrameAutoresList(java.awt.Frame parent, boolean modal) throws ClassNotFoundException, SQLException{
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameAutoresList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    FrameAutoresList dialog = new FrameAutoresList(new javax.swing.JFrame(), true);
                    ...
                    Logger.getLogger(FrameAutoresList.class.getName()).log(Level.SEVERE, null, ex);
